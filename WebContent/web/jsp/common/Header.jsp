	...
	<div id="header1" class="row">
		...
		<div class="col-md-1">
			...
			<div class="dropdown dropdown-menu-right">
				<img src="<%=strContextPath%>/resources/images/users/rk.jpg"
					" alt="Avatar" class="avatar dropdown-toggle"
					data-toggle="dropdown">
				<ul class="dropdown-menu" role="menu" >
					<li role="presentation"><a role="menuitem" href="#">Profile</a></li>
					<li role="presentation"><a role="menuitem" href="#">Settings</a></li>
					<li class="divider"></li>
					<li role="presentation"><a role="menuitem" href="<%=strContextPath%>/Login?hidden=logOff">Log out</a></li>
				</ul>
			</div>
		</div>
	</div>
			...
			<div class="collapse navbar-collapse" id="navbarSupportedContent">
				<ul class="navbar-nav mr-auto">
					...
					<a class="nav-link  active"
						href="<%=strContextPath%>/web/jsp/common/DashBoard.jsp"><i
