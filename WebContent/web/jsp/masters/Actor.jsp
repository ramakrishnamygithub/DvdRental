...
<script type="text/javascript"
	src="<%=strContextPath%>/dwr/interface/actorService.js"></script>
<script type="text/javascript"
	src="<%=strContextPath%>/resources/scripts/masters/actor.js"></script>
								...
								<div class="modal-content">
									...
									<div class="modal-body">
										<div id="modalbody">
											<div class="form-group">
												<input id="actorId" type="hidden" value="" /> <label
													for="actor">Actor:</label> <input type="text"
									...
									<div class="modal-footer">
										<button type="button" class="btn btn-primary"
											data-dismiss="modal" onclick="modifyActor(this);">Save</button>
