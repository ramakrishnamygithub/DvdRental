...
<script type="text/javascript"
	src="<%=strContextPath%>/dwr/interface/languageService.js"></script>
<script type="text/javascript"
	src="<%=strContextPath%>/resources/scripts/masters/language.js"></script>
								...
								<div class="modal-content">
									...
									<div class="modal-body">
										<div id="modalbody">
											<div class="form-group">
												<input id="languageId" type="hidden" value="" /> <label
													for="language">Language:</label> <input type="text"
									...
									<div class="modal-footer">
										<button type="button" class="btn btn-primary"
											data-dismiss="modal" onclick="modifyLanguage(this);">Save</button>
