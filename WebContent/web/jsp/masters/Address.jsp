...
<script type="text/javascript"
	src="<%=strContextPath%>/dwr/interface/addressService.js"></script>
<script type="text/javascript"
	src="<%=strContextPath%>/resources/scripts/masters/address.js"></script>
								...
								<div class="modal-content">
									...
									<div class="modal-body">
										<div id="modalbody">
											<div class="form-group">
												<input id="addressId" type="hidden" value="" /> <label
									...
									<div class="modal-footer">
										<button type="button" class="btn btn-primary"
											data-dismiss="modal" onclick="modifyAddressthis);">Save</button>
