...
<script type="text/javascript"
	src="<%=strContextPath%>/dwr/interface/categoryService.js"></script>
<script type="text/javascript"
	src="<%=strContextPath%>/resources/scripts/masters/category.js"></script>
								...
								<div class="modal-content">
									...
									<div class="modal-body">
										<div id="modalbody">
											<div class="form-group">
												<input id="categoryId" type="hidden" value="" /> <label
													for="category">Category:</label> <input type="text"
									...
									<div class="modal-footer">
										<button type="button" class="btn btn-primary"
											data-dismiss="modal" onclick="modifyCategory(this);">Save</button>
